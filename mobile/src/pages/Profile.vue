      ...
      <div class="flex flex-col items-center justify-around h-full">
        <div class="flex flex-col items-center gap-3">
          <div class="circular-image-container">
            ...
            <div
              v-else
              class="flex items-center justify-center bg-gray-300 h-full w-full"
            >
              <p class="text-gray-700 text-[75px]">
                {{ cookies.get('full_name')[0] }}
              </p>
            </div>
          </div>
        ...
        <div class="flex flex-col gap-3">
          ...
          >
            <div
              class="flex gap-3 bg-[#a3b6e0] pt-2 pb-2 w-56 justify-center items-center rounded-lg"
            >
              <p>Logout</p>
