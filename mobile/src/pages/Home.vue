<template>
  <div class="sm:w-96 font-[Inter]">
    ...
    <div v-if="!mobileModules.list.loading">
      <div
        class="pt-15 flex justify-evenly"
        v-if="mobileModules.data && employee.name"
      >
        <ThemeButton
      ...
      <div v-else class="pt-10 pl-6 pr-6">
        <div
          class="pt-3 pb-4 border-2 border-[#B9C8EA] text-center rounded-lg bg-[#D6E1F9] font-[Inter] font-[600]"
        >
