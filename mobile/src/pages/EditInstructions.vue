        ...
        <div>
          ...
          <div class="text-center pt-4 pb-5">
            <PrimaryButton
              ...
              :loading="projectAllocationInstructionResource.setValue.loading"
            ></PrimaryButton>
          </div>
        </div>
      </div>
      <div>
        ...
        <div>
          ...
          <div v-if="employeeInstructionId">
            <textarea
              class="border-0 w-full h-48"
              v-model="employeeInstruction"
            ></textarea>
            <div class="text-center pt-4 pb-5">
              <PrimaryButton
                name="Save"
                @click="setEmployeeInstruction"
                :loading="employeeInstructionListResource.setValue.loading"
              ></PrimaryButton>
            </div>
          </div>
        </div>
