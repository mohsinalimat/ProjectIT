<template>
  <div
    class="fixed pr-5 pt-5 w-full flex justify-end"
    @click="emit('close-event', true)"
  >
  ...
  <div v-if="!showPreview" class="h-screen">
    ...
    <div
      class="fixed bottom-12 w-full flex items-center justify-between pl-10 pr-10"
    >
      <div>
...
function captureImage() {
  ...
  imageFile.value = dataURLtoFile(
    dataurl,
    `${new Date().toISOString()}_${props.mode}.png`
  )
}
